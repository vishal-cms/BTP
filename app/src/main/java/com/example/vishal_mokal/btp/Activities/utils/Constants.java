...
public class Constants {
   ...
   public final static String USER_REGISTRATION_URL = "http://182.74.160.157/MobileRegistration/RegistrationForm.asmx";
    ...
    public final static String GET_VOILATION_URL = "http://182.74.160.157/MobileRegistration/RegistrationForm.asmx";
    public final static  String GET_VOILATION_NAMESPACE = "http://tempuri.org/";
    public final static String GET_VOILATION_METHOD_NAME = "UserRegistration";
    public final static String GET_VOILATION_SOAP_ACTION = "http://tempuri.org/UserRegistration";
